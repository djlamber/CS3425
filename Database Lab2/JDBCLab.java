...
public class JDBCLab {
	...
	public int withdraw2(String account_number, double amount) {
		...
		try {
			stmt = conn.prepareStatement("update lab2_account set balance = balance - " + amount +" where account_number = \"" + account_number+"\"");
	...
	public static void main(String args[]) {
		...
		dblab.withdraw("X' or account_number = 'A001'#", 10);
		dblab.withdraw2("X' or account_number = 'A001'#", 10);
		dblab.disconnect();
	}
}
